...
<body>
    <div class="container">
        ...
        <ul id="social-media-links" class="nav nav-pills nav-justified">
            ...
            <li><a href="http://github.com/jlstrater/gr8ladies" target="_blank"><i class="fa fa-github fa-3x"></i></a></li>
            <li><a href="http://zazzle.com/gr8ladies*" target="_blank"><i class="fa fa-shopping-cart fa-3x"></i></a></li>
            <li><a><form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
