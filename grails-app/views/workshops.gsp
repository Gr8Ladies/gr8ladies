...
<head>
    ...
    <title>Workshops - Gr8Ladies</title>
</head>
    ...
    <div class="row">
        <div class="box">
            <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="col-md-5">
                        <asset:image class="img-responsive img-border img-left" src="gr8workshopspackets.jpg"/>
                    </div>
                    ...
                    <div>
                        ...
                        <p>Coffee, light refreshments, and lunch will be provided.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <asset:image class="hidden-xs img-responsive img-border img-left" src="workshop_advanced.jpg"/>
                </div>
        ...
        <div class="box">
            <div class="col-lg-12">
                ...
                <h2 class="intro-text text-center">Volunteers</h2>
                <hr>

                <div>
                    <p>Gr8Workshops is only possible because of our amazing volunteers.  We are always looking for more instructors of special topics courses and Teaching Assistants(TA) to help with setup. Even if you
        ...
        <div class="box">
            <div class="col-lg-12">
                ...
                <h2 class="intro-text text-center">Sponsors</h2>
                <hr>

                <div>
                    <p>Sponsors are essential for putting on this event.  From food, to space, to helping compensate our volunteers, every little bit helps.  As a corporate sponsor,
